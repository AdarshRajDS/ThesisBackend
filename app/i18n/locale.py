...
def build_mcp_system_prompt(language: SupportedLanguage) -> str:
    base = (
        ...
        "German structure names are translated to English catalog labels before matching "
        "(e.g. Leber→Liver); prefer any provided Catalog part_query hint. "
    ...
    if language == "de":
        base = (
            ...
            "Deutsche Strukturnamen werden vor dem Katalog-Matching ins Englische übersetzt "
            "(z. B. Leber→Liver); nutzen Sie den Hinweis „Catalog part_query“, falls vorhanden. "
