...
Requirements files, \codepath{package-lock.json}, Docker images, model identifiers, and the repository hash provide partial version evidence. \Cref{tab:environment-versions} separates declared values from information that depends on the final machine.

\small
\setlength{\tabcolsep}{3pt}
\begin{longtable}{L{0.23\textwidth}L{0.39\textwidth}L{0.29\textwidth}}
  \caption{Environment and version record for the frozen implementation.}
  ...
  \bottomrule
  \endlastfoot
  Repository snapshot & \nolinkurl{cb041d52787f469bbbe0434e9fc7690edc122afa} & Verified from ZIP archive comment. \\
